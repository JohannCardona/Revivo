...
@emotion_classifier.route("/emotion_classifier", methods=['GET'])
def fetch_emotion_from_text(input: str):
    """
    ...
    text_tokens = sentence_tokenizer(input, add_special_tokens=True, padding="max_length", truncation=True, max_length=MAX_LENGTH, return_tensors="tf")
